...
<html>
    ...
    <body>
        ...
        <section class="hero">
            ...
            <p>Bridging the gap between talent and opportunities in undeserved communities.</p>
    ...
    <script>
        ...
        .then(data => {
            ...
            status.innerHTML = "✅ Thank you for contacting us. We will get back to you soon.";
            form.reset();
        })
        .catch(error => {
            status.style.display = "block";
